...
import {getProductDetails, newReview, clearErrors} from '../../redux/productActions'
...
const ProductDetails = ()=>{
    ...
    const {error:reviewError,success} = useSelector(state=>state.numReview)
            ...
            loading ? <Loader /> : (
                ...
                <div className="row f-flex justify-content-around">
                    ...
                    <div className="col-12 col-lg-5 mt-5">
                        ...
                        <p>Status: <span id="stock_status" className = {product.stock > 0 ? "greenColor" : "redColor" }>{ product.stock > 0 ? 'inStock' : 'outStock' }</span></p>
